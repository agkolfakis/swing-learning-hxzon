...
//            urlGenerator = new StandardXYURLGenerator();
        ...
        //AbstractCategoryItemRenderer.findRangeBounds(CategoryDataset, boolean)
        //AbstractXYItemRenderer.findDomainBounds(XYDataset, boolean)
        //AbstractXYItemRenderer.findRangeBounds(XYDataset, boolean)
        renderer.setDataBoundsIncludesVisibleSeriesOnly(false);
        renderer.setBaseSeriesVisibleInLegend(true);//invalidation
        //Plot
