...
public class AllDemos extends JFrame {
    ...
    private static final String[] DEMO_CLASS_NAMES = new String[] { "org.flexdock.demos.maximizing.MaximizationDemo", "org.flexdock.demos.perspective.PerspectivesDemo",
            "org.flexdock.demos.perspective.XMLPerspectivesDemo", "org.flexdock.demos.raw.adapter.AdapterDemo", "org.flexdock.demos.raw.border.BorderDemo", "org.flexdock.demos.raw.CompoundDemo",
            "org.flexdock.demos.raw.elegant.ElegantDemo", "org.flexdock.demos.raw.jmf.JMFDemo", "org.flexdock.demos.raw.SimpleDemo", "org.flexdock.demos.raw.SplitPaneDemo",
            "org.flexdock.demos.raw.TabbedPaneDemo", "org.flexdock.demos.view.ViewDemo", };
    ...
    public AllDemos() {
        ...
        for (int i = 0; i < DEMO_CLASS_NAMES.length; i++) {
            ...
            String just_class_name = full_class_name.substring(full_class_name.lastIndexOf('.') + 1);
            sorted_class_names.put(just_class_name, full_class_name);
        }

        getContentPane().setLayout(new GridLayout(0, 1, 3, 3));
        for (Iterator iter = sorted_class_names.entrySet().iterator(); iter.hasNext();) {
