...
public class TooManyBallsBroken {
    ...
    private void addBall() {
        ...
        ball.ts.init();
        ball.animator = new AnimatorBuilder(ball.ts).setDuration(duration, TimeUnit.SECONDS).addTarget(circularMovement).setRepeatCount(Animator.INFINITE)
                .setRepeatBehavior(Animator.RepeatBehavior.LOOP).setInterpolator(i).build();
        ball.animator.start();
