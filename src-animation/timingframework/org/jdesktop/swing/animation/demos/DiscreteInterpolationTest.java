...
public class DiscreteInterpolationTest extends TimingTargetAdapter {
    ...
    private static void setupGUI() {
        ...
        final KeyFrames<Integer> keyFrames = new KeyFramesBuilder<Integer>().addFrames(2, 6, 3, 5, 4).setInterpolator(DiscreteInterpolator.getInstance()).build();
        ...
        final Animator animator = new AnimatorBuilder().setDuration(3, TimeUnit.SECONDS).addTarget(PropertySetter.getTarget(object, "intValue", keyFrames)).addTarget(object).build();
        out("");
