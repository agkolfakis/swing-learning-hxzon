...
public class TooManyBalls implements JRendererTarget<GraphicsConfiguration, Graphics2D> {
    ...
    private void addBall() {
        ...
        ball.animator = new AnimatorBuilder().setDuration(duration, TimeUnit.SECONDS).addTarget(circularMovement).setRepeatCount(Animator.INFINITE).setRepeatBehavior(Animator.RepeatBehavior.LOOP)
