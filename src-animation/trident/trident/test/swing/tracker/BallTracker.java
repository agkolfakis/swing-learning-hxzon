package trident.test.swing.tracker;
    ...
    public BallTracker() throws Exception {
        ...
        easeCombo.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                return super.getListCellRendererComponent(list, ((Map.Entry<String, TimelineEase>) value).getKey(), index, isSelected, cellHasFocus);
            }
        });
        ...
        runTimeline.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                timelineBallFalling.addPropertyToInterpolate("ballY", BallPanel.RADIUS, ballPanel.getHeight() - BallPanel.RADIUS);
                ...
                timelineBallFalling.setEase(((Map.Entry<String, TimelineEase>) easeCombo.getSelectedItem()).getValue());
                ...
                timelineBallFalling.addCallback(new TimelineCallbackAdapter() {
                    ...
                    public void onTimelineStateChanged(TimelineState oldState, TimelineState newState, float durationFraction, float timelinePosition) {
                        System.out.println("State change: " + oldState.name() + " -> " + newState.name());
                    }
                });
