...
public class TextCheckerUtilTest {
    public static void main(String[] args) {
        ...
        c.check("12.5", "鸡蛋价格");
        c.removeChecker("int");
        c.addChecker("double", "min=12.5;typeError=不是浮点数;rangeError=需大于:max或小于:min");
        c.check("11.5", "价格");

//         c.clearErrorMessage();
        c.clearChecker();
        c.addChecker("date", "pattern=yyyyMMdd;min=19851230;typeError=时间格式错误;rangeError=时间范围不对");
        c.check("19851229", "出生日期");
        c.removeChecker("date");
        c.addChecker("time", ";min=12:30:45;typeError=时间格式错误;rangeError=时间范围不对");
