...
public class DatePopup extends JPopupMenu {
    private static final Month[] MONTHS = { new Month(1), new Month(2), new Month(3), new Month(4), new Month(5), new Month(6), new Month(7), new Month(8), new Month(9), new Month(10), new Month(11),
            new Month(12) };
