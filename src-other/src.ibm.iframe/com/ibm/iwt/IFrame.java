    ...
    public void windowResized(WindowChangeEvent e) {
        ...
        if (e.isDragging()) {
            ...
            case WindowChangeEvent.RESIZE_NORTH: {
                r.update((int) getLocation().getX(), (int) getLocation().getY() + e.getChangeY(), getWidth(), getHeight() - e.getChangeY());
                break;
            }
            case WindowChangeEvent.RESIZE_NORTH_EAST: {
                r.update((int) getLocation().getX(), (int) getLocation().getY() + e.getChangeY(), e.getPosX(), getHeight() - e.getChangeY());
                break;
            }
            case WindowChangeEvent.RESIZE_NORTH_WEST: {
                r.update((int) getLocation().getX() + e.getChangeX(), (int) getLocation().getY() + e.getChangeY(), getWidth() - e.getChangeX(), getHeight() - e.getChangeY());
                break;
            }
            ...
            case WindowChangeEvent.RESIZE_SOUTH_WEST: {
                r.update((int) getLocation().getX() + e.getChangeX(), (int) getLocation().getY(), getWidth() - e.getChangeX(), e.getPosY());
                break;
            }
            case WindowChangeEvent.RESIZE_WEST: {
                r.update((int) getLocation().getX() + e.getChangeX(), (int) getLocation().getY(), getWidth() - e.getChangeX(), getHeight());
                break;
            }
            }
        }
